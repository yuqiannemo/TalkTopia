...
class TalksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talk" do
    assert_difference("Talk.count") do
      post talks_url, params: { talk: { importance: @talk.importance, topic: @talk.topic, tribe: @talk.tribe } }
    end
  ...
  test "should update talk" do
    patch talk_url(@talk), params: { talk: { importance: @talk.importance, topic: @talk.topic, tribe: @talk.tribe } }
